...
##############################
##############################
# Please Replace the "0.0.0.0" in the last line with the IP of your container.
# You see your container IP when you run "sudo docker run -it ubuntu:latest /bin/bash"
##############################
...
rm -rf /etc/puppetlabs/puppet/ssl
								          # REPLACE WITH YOUR PUPPETSERVER NAME!
/opt/puppetlabs/server/apps/puppetserver/bin/puppetserver ca setup --subject-alt-names puppetserver.example.com,puppet
